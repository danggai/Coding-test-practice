...
def solution(n):
    ...
    while (length != 1):
        ...
        temp = [[] for _ in range(0 , prime * len(lists))]
        count = -1
        for list in lists:
            count += 1
            for i in range(0, len(list)):
                temp[count * prime + i % prime].append(list[i])
...
n = 12	
print(solution(n))
print("expect = [1, 5, 9, 3, 7, 11, 2, 6, 10, 4, 8, 12]")

n = 18
print(solution(n))
print("expect = [1, 7, 13, 3, 9, 15, 5, 11, 17, 2, 8, 14, 4, 10, 16, 6, 12, 18]")